<p align="center">
  <img src="assets/mapick_banner.png" alt="Mapick Banner" width="720" />
</p>
...
- Read every line of `redact.js` — see exactly what gets filtered
- Read `shell.js` — see every command that runs
